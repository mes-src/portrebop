...
'''
### Naive Rebalancing ###
based upon individual security pricing and drifts against target
'''
...
'''
### 'Intuitive' Tax & Type Aware Rebalancing ### 
'''
...
'''
@ todo: seperate flagged execution dataframe into tiers based upon account type or tax considerations - 'execute' A tier orders before
B tier and so on, rebalancing the entire account based upon relative drift % from tolerance, but using intuition as to which 
which orders should be purchased or sold first until all new funds or quantity goal to liquidate == 0. 
'''
